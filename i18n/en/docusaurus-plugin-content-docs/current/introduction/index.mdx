...
<FontAwesomeIcon icon="fa-solid fa-arrow-right" /> [Invite the bot](https://discord.com/api/oauth2/authorize?client_id=1182819335878754385&permissions=395137215504&scope=bot+applications.commands)
...
<FontAwesomeIcon icon="fa-solid fa-arrow-right" /> It uses the [@diceRoller API](https://dice-roller.github.io/documentation/) to perform dice rolls. It also supports the rollem notation `4#(dice)` for "bulk rolls".
